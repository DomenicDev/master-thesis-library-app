...
import de.cassisi.cataloguesearchprojector.eventhandler.EventHandler
import de.cassisi.cataloguesearchprojector.checkpoint.CheckpointStorage
...
class CatalogueSubscription(
    ...
    companion object {
        ...
        // CHECKPOINT NAME
        private const val CHECKPOINT_KEY = "catalogue-search-projector"
    }
